...
<div class="w-full h-screen flex justify-center items-center bg-center"
    ...
    <div class="sm:w-11/12 max-w-6xl h-screen sm:m-4 m-auto p-2 xl:p-4 rounded sm:overflow-y-hidden text-primary flex flex-col sm:flex-row sm:justify-center sm:items-center">
