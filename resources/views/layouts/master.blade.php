...
<!--
    ...
    <nav class="w-full fixed flex justify-center top-0 lg:mt-4 z-10">
      <div class=" w-full flex justify-between lg:px-10 md:px-5 md:text-base text-sm">
        <div class="flex md:w-auto w-full justify-around">
          <a href="#" class="nav-button self-center p-2 px-4 m-1 {{ (request() -> is('/') || is('/home')) ? 'active' : '' }} " >Home</a>
    ...
    <div class="flex md:hidden absolute top-20 left-50 translateX-n50 text-sm z-10">
      <a href="#" class="p-2 m-1 border border-primary rounded">
      ...
      <a href="#" class="p-2 m-1 border border-primary rounded">
        <svg class="inline" height="1rem" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 408.788 408.788" xml:space="preserve">
          <path style="fill:#0000dd;" d="M353.701,0H55.087C24.665,0,0.002,24.662,0.002,55.085v298.616c0,30.423,24.662,55.085,55.085,55.085
          h147.275l0.251-146.078h-37.951c-4.932,0-8.935-3.988-8.954-8.92l-0.182-47.087c-0.019-4.959,3.996-8.989,8.955-8.989h37.882
          v-45.498c0-52.8,32.247-81.55,79.348-81.55h38.65c4.945,0,8.955,4.009,8.955,8.955v39.704c0,4.944-4.007,8.952-8.95,8.955
          l-23.719,0.011c-25.615,0-30.575,12.172-30.575,30.035v39.389h56.285c5.363,0,9.524,4.683,8.892,10.009l-5.581,47.087
