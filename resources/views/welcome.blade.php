...
<div class="sm:text-xs block ">
    ...
    <div class="lg:w-1/2 md:w-3/4 w-4/5 lg:absolute-center-40 absolute-center" style="font-family: 'Major Mono Display', monospace;">
    ...
    <div class="lg:w-1/3 md:w-1/2 w-3/5 mx-auto lg:fixed-center-40 fixed-center">
